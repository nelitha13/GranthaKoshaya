...
<div class="navbar">
    ...
    <nav>
        <form method="post" action="src/server.php">
            <input type="text" style="display:inline-block;height:25px;width: 200px;" placeholder="Type Here to Search" name="search" />
        ...
        <ul id="MenuItems">
            ...
            <?php if (isset($_SESSION['user_email'])) { ?>
                ...
                <?php if ($_SESSION['is_admin']) { ?>
                    ...
                    <span title="Admin"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-award" viewBox="0 0 16 16">
